                        ...
                        <div class="col-sm-12">
                            <div class="card">
                                ...
                                <div class="card-block">
                                    <form action="{{ route('ipk-lulusan.update', $editData->id) }}" method="POST">
                                        @csrf
                                        @method('put')
                                        ...
                                        <div class="form-group">
<<<<<<< HEAD:resources/views/admprodi/page/ipk_lulusan/form_edit.blade.php
...
>>>>>>> origin/prefered_dev:resources/views/ipk_lulusan/edit.blade.php
                                        </div>
