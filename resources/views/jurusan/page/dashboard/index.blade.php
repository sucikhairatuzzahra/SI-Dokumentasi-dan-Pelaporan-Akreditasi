                            ...
                            <div class="table-responsive">
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>Kriteria 3</td>
                                            <td><a href="{{ route('jurusan-mahasiswa') }}">Mahasiswa</a></td>
                                        </tr>
                                        <tr>
                                            <td>Kriteria 4</td>
                                            <td><a href="{{ route('jurusan-kependidikan') }}">Sumber Daya Manusia</a> </td>
                                        </tr>
                                        <tr>
                                            <td>Kriteria 5</td>
                                            <td><a href="{{ route('jurusan-saranaprasarana') }}">Keuangan, Sarana dan
                                                    Prasarana</a></td>
                                        </tr>
                                        <tr>
                                            <td>Kriteria 6</td>
                                        ...
                                        <tr>
                                            <td>Kriteria 9</td>
                                            <td><a href="{{ route('jurusan-ipklulusan') }}">Luaran dan Capaian Tridarma</a>
                                            </td>
                                        </tr>
                                    </tbody>
