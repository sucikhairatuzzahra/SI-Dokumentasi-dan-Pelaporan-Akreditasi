                        ...
                        <div class="col-sm-12">
                            <div class="card">
                                ...
                                <div class="card-block">
                                    <form action="{{ route('aksesibilitas.update', $editData->id) }}" method="POST">
                                        @csrf
                                        @method('put')
                                        ...
                                        <div class="form-group">
<<<<<<< HEAD:resources/views/admprodi/page/aksesibilitas/form_edit.blade.php
...
>>>>>>> origin/prefered_dev:resources/views/aksesibilitas/edit.blade.php
                                        </div>
