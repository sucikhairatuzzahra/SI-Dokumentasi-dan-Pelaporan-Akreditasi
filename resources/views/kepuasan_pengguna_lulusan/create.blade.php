...
<<<<<<< HEAD:resources/views/admprodi/page/kepuasan_pengguna_lulusan/form.blade.php
...
=======
                                            ...
                                            <input type="text" class="form-control" value="{{ $ptUnit->kode_pt_unit }}"
                                                disabled>
>>>>>>> origin/prefered_dev:resources/views/kepuasan_pengguna_lulusan/create.blade.php
                                        </div>
