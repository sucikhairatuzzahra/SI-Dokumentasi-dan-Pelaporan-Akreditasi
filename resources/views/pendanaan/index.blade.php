                                ...
                                <table class="table table-bordered">
                                    <thead>
                                        <tr style="text-align-last: center">
                                            ...
                                            <th scope="col">
                                                Unit Kerja
<<<<<<< HEAD:resources/views/admprodi/page/pendanaan/index.blade.php
                                            </th>
                                            <th scope="col">
                                                Aksi
=======
>>>>>>> origin/prefered_dev:resources/views/pendanaan/index.blade.php
                                            </th>
                                            @can('isAdmProdi')
                                                ...
                                                @can('isAdmProdi')
                                                    <td>
                                                        <form action="{{ route('pendanaan.destroy', ['id' => $item->id]) }}"
                                                            ...
                                                            @csrf
                                                            @method('DELETE')
                                                            <a href="{{ route('pendanaan.edit', ['id' => $item->id]) }}"
                                                                style="margin-right: 7px">
                                                                Edit
                                                            </a>
