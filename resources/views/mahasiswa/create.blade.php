                                ...
                                <div class="card-block">
                                    <form action="{{ route('mahasiswa.store') }}" method="POST">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" placeholder="0" class="form-control" name="lulus_seleksi"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" placeholder="0" class="form-control" name="maba_reguler"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" placeholder="0" class="form-control" name="maba_transfer"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" placeholder="0" class="form-control"
                                                name="mhs_aktif_reguler" value="{{ old('mhs_aktif_reguler') }}" required>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" placeholder="0" class="form-control"
                                                name="mhs_aktif_transfer" value="{{ old('mhs_aktif_transfer') }}" required>
