                                ...
                                <form action="{{ route('mahasiswa.update', $editData->id) }}" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="thn_akademik" class="form-control" required>
                                            ...
                                            <option value="{{ $row->id }}" {{ $editData->id_thn_akademik == $row->id ? 'selected' : '' }}>
                                                {{ $row->tahun }}
                                            </option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" placeholder="0" class="form-control" name="daya_tampung" value="{{ $editData->daya_tampung }}" required>
                                        <p class="text-danger">{{ $errors->first('daya_tampung') }}</p>
                                    </div>
                                    <div class="form-group">
                                        <label for="pendaftar">Jumlah Pendaftar</label>
                                        <input type="number" placeholder="0" class="form-control" name="pendaftar" value="{{ $editData->pendaftar }}" required>
                                        <p class="text-danger">{{ $errors->first('pendaftar') }}</p>
                                    </div>
                                    <div class="form-group">
                                        <label for="lulus_seleksi">Jumlah Lulus Seleksi</label>
                                        <input type="number" placeholder="0" class="form-control" name="lulus_seleksi" value="{{ $editData->lulus_seleksi }}" required>
                                        <p class="text-danger">{{ $errors->first('lulus_seleksi') }}</p>
                                    </div>
                                    <div class="form-group">
                                        <label for="maba_reguler">Jumlah Mahasiswa Baru Reguler</label>
                                        <input type="number" placeholder="0" class="form-control" name="maba_reguler" value="{{ $editData->maba_reguler }}" required>
                                        <p class="text-danger">{{ $errors->first('maba_reguler') }}</p>
                                    </div>
                                    <div class="form-group">
                                        <label for="maba_transfer">Jumlah Mahasiswa Baru Transfer</label>
                                        <input type="number" placeholder="0" class="form-control" name="maba_transfer" value="{{ $editData->maba_transfer }}" required>
                                        <p class="text-danger">{{ $errors->first('maba_transfer') }}</p>
                                    </div>
                                    <div class="form-group">
                                        <label for="mhs_aktif_reguler">Jumlah Mahasiswa Aktif Reguler</label>
                                        <input type="number" placeholder="0" class="form-control" name="mhs_aktif_reguler" value="{{ $editData->mhs_aktif_reguler }}" required>
                                        <p class="text-danger">{{ $errors->first('mhs_aktif_reguler') }}</p>
                                    </div>
                                    <div class="form-group">
                                        <label for="mhs_aktif_transfer">Jumlah Mahasiswa Aktif Transfer</label>
                                        <input type="number" placeholder="0" class="form-control" name="mhs_aktif_transfer" value="{{ $editData->mhs_aktif_transfer }}" required>
                                        <p class="text-danger">{{ $errors->first('mhs_aktif_transfer') }}</p>
                                    </div>
                                    <div class="form-group">
                                        <label for="pt_unit">Unit Kerja</label>
                                        <input type="hidden" class="form-control" value="{{ $editData->ptUnit->id }}" required>
                                        <input type="text" class="form-control" value="{{ $editData->ptUnit->kode_pt_unit }}" disabled>
                                    </div>
