<nav class="pcoded-navbar">
    ...
    <div class="pcoded-inner-navbar main-menu">
        ...
        <ul class="pcoded-item pcoded-left-item">
            <li class="">
                <a href="{{ route('kaprodi-home') }}" class="waves-effect waves-dark">
            ...
            <li>
                <a href="{{ route('kaprodi-mahasiswa') }}" class="waves-effect waves-dark">
        ...
        <ul class="pcoded-item pcoded-left-item">
            <li>
                <a href="{{ route('kaprodi-bebandtpr') }}" class="waves-effect waves-dark">
                    <span class="pcoded-micon"><i class="ti-layers"></i><b>FC</b></span>
            ...
            <li>
                <a href="{{ route('kaprodi-kependidikan') }}" class="waves-effect waves-dark">
                    <span class="pcoded-micon"><i class="ti-layers"></i><b>FC</b></span>
        ...
        <ul class="pcoded-item pcoded-left-item">
            <li>
                <a href="{{ route('kaprodi-sumberdana') }}" class="waves-effect waves-dark">
                    <span class="pcoded-micon"><i class="ti-layers"></i><b>FC</b></span>
            ...
            <li>
                <a href="{{ route('kaprodi-aksesibilitas') }}" class="waves-effect waves-dark">
                    <span class="pcoded-micon"><i class="ti-layers"></i><b>FC</b></span>
            ...
            <li>
                <a href="{{ route('kaprodi-saranaprasarana') }}" class="waves-effect waves-dark">
                    <span class="pcoded-micon"><i class="ti-layers"></i><b>FC</b></span>
        ...
        <ul class="pcoded-item pcoded-left-item">
            <li>
                <a href="{{ route('kaprodi-ipklulusan') }}" class="waves-effect waves-dark">
                    <span class="pcoded-micon"><i class="ti-layers"></i><b>FC</b></span>
            ...
            <li>
                <a href="{{ route('kaprodi-kelulusan_tepatwaktu') }}" class="waves-effect waves-dark">
                    <span class="pcoded-micon"><i class="ti-layers"></i><b>FC</b></span>
            ...
            <li>
                <a href="{{ route('kaprodi-kepuasan_pengguna') }}" class="waves-effect waves-dark">
                    <span class="pcoded-micon"><i class="ti-layers"></i><b>FC</b></span>
            ...
            <li>
                <a href="{{ route('kaprodi-masatunggu') }}" class="waves-effect waves-dark">
                    <span class="pcoded-micon"><i class="ti-layers"></i><b>FC</b></span>
            ...
            <li>
                <a href="{{ route('kaprodi-kerjalulusan') }}" class="waves-effect waves-dark">
                    <span class="pcoded-micon"><i class="ti-layers"></i><b>FC</b></span>
            ...
            <li>
                <a href="{{ route('kaprodi-ppkm_dtpr') }}" class="waves-effect waves-dark">
                    <span class="pcoded-micon"><i class="ti-layers"></i><b>FC</b></span>
