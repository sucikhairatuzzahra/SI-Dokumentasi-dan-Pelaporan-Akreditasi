                        ...
                        <div class="col-sm-12">
                            <div class="card">
                                ...
                                <div class="card-block">
                                    <form action="{{ route('luaran-ppkm.update', $editData->id) }}" method="POST">
                                        @csrf
                                        @method('put')
                                            ...
                                            <select name="jenis_luaran" id="jenis_luaran" class="form-control">
                                                @foreach ($jenisLuarans as $jenisLuaran)
                                                    <option value="{{ $jenisLuaran->id }}"
                                                        {{ $editData->id_jenis_luaran == $jenisLuaran->id ? 'selected' : '' }}>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="judul_luaran_ppkm"
                                                name="judul_luaran_ppkm" value="{{ $editData->judul_luaran_ppkm }}">
                                        </div>
                                        <div class="form-group">
