            ...
            <div class="row align-items-center">
                <div class="col-md-8">
                    <div class="page-header-title">
                        ...
                        <p class="m-b-0">Form Hak Kekayaan Intelektual PPKM Infokom</p>
                    </div>
                </div>
                <div class="col-md-4">
                        ...
                        <div class="col-sm-12">
                            <div class="card">
                                <div class="card-header">
                                    <h5>Form Hak Kekayaan Intelektual PPKM Infokom</h5>
                                    {{-- <span>Add class of <code>.form-control</code> with <code>&lt;input&gt;</code> tag</span> --}}
                                </div>
                                <div class="card-block">
                                    <form action="{{ route('luaran-lain-ppkm.store') }}" method="POST">
                                        @csrf
                                        ...
                                        <div class="form-group">
                                            <label for="id_jenis_luaran_lain">Jenis Publikasi</label>
                                        ...
                                        <div class="form-group">
                                            <label for="judul_luaran_lain">Judul Hak Kekayaan Intelektual</label>
                                            <input type="text" class="form-control" id="judul_luaran_lain"
                                                name="judul_luaran_lain">
                                        </div>
                                        <div class="form-group">
